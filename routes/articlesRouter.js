...
// import controllers
import { createNewArticle, getAllArticles, getSingleArticle, updateArticle } from '../controllers/articlesController.js';
...
articlesRouter.route("/:id").get(getSingleArticle).put(updateArticle);
// export Router
